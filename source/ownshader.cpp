...
Shader::Shader() : SCR_WIDTH(800), SCR_HEIGHT(600), shaderProgram(0) {
...
Shader::Shader(const unsigned int width, const unsigned int height, GLFWwindow* window) : SCR_WIDTH(width), SCR_HEIGHT(height), shaderProgram(0), window(window) {
	...
	glfwMakeContextCurrent(window);
	//glfwSetFramebufferSizeCallback(window, shader::framebuffer_size_callback);
